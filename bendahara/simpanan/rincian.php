...
if (mysqli_num_rows($check_simpanan) == 0) {
    header("Location: ".cfg(url)."bendahara/simpanan");
} else {
                                        ...
                                        <table class="table" id="tables">
											...
											<tbody>
												...
												<tr>
													...
													<td>
													<? if ($data_simpanan['tipe'] != 'Belum Dibayar') { ?>
													<button class="btn btn-outline-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <? echo $data_simpanan['status']; ?>
                                                    </button>
                                                    <? } else { ?>
                                                    ...
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/simpanan/bayar?1=<? echo $data_simpanan['id']; ?>&2=Cash">Cash</a></li>
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/simpanan/bayar?1=<? echo $data_simpanan['id']; ?>&2=Transfer">Transfer</a></li>
                                                    <li>
                                                    <? } ?>
                                                    </td>
                                                    <td>
