		...
		$data_pelajaran = mysqli_fetch_assoc($check_pelajaran);
				if (isset($_POST['delete'])) {
					if (mysqli_num_rows($check_pelajaran) == 0) {
						$msg_type = "error";
						$msg_content = "<b>Gagal:</b> Pelajaran tidak tersedia atau sudah terhapus.";
					} else {
						$delete = mysqli_query($db, "DELETE FROM pelajaran WHERE id = '$post_id'");
				        if ($delete == TRUE) {
							$msg_type = "success";
							$msg_content = "<b>Berhasil:</b> Pelajaran ".$data_pelajaran['nama']." berhasil dihapus.<br />";
						} else {
							$msg_type = "error";
...
?>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header text-uppercase">Hapus Data Pelajaran</div>
                                        <div class="card-body">
										<?php 
										if ($msg_type == "success") {
										?>
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="form-group">
												...
												<div class="col-md-12">
													<input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Pelajaran" value="<? echo $data_pelajaran['nama']; ?>" readonly>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">JURUSAN *</label>
												<div class="col-md-12">
													<input type="text" name="jurusan" class="form-control" placeholder="Masukkan Jurusan" value="<? echo $data_pelajaran['jurusan']; ?>" readonly>
												</div>
											</div>
											<div class="form-group">
