                    ...
                    <div class="form-group col-lg-12"><br />
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <select class="form-control" name="pelajaran" id="pelajaran" required>
                                ...
                                <?php
                                $check_jurusan = mysqli_query($db, "SELECT * FROM pelajaran WHERE nama = '".$data_user['pelajaran']."'");
                                if (mysqli_num_rows($check_jurusan) == 0) {
                                    $check = mysqli_query($db, "SELECT * FROM pelajaran WHERE jurusan = '".$data_user['pelajaran']."' ORDER BY nama ASC");
                                } else {
