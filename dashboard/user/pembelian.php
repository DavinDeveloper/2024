			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">Pembelian Anda</h4>
						<div class="row">
							<div class="col-md-12">
									<div class="card-body ">
								    <div class="card">
									...
									<div class="card-body">
                                        ...
                                        <table class="table" id="tables">
											...
											<tbody>
											    <?
											    $no = 1;
											    $check_pembelian = mysqli_query($db, "SELECT * FROM pembelian WHERE username = '".$user['username']."' ORDER BY id ASC");
												...
												<tr>
													...
													<td>
													    ...
													    <? } else { ?>
													    <a href="<? echo cfg(url); ?>dashboard/user/bayar?1=<? echo $data_pembelian['id']; ?>" class="btn btn-primary">Upload</a>
													    <? } ?>
													</td>
													...
													<td>
													    ...
													    <a href="<? echo cfg(url); ?>invoice/<? echo $data_pembelian['id']; ?>" class="btn btn-primary" target="_BLANK">Lihat</a>
													    <? } else if ($data_pembelian['status'] == 'Dibatalkan') { ?>
													    <a href="#" class="btn btn-secondary" target="_BLANK">Dibatalkan</a>
													    <? } else { ?>
													    <a href="#" class="btn btn-primary">Belum Dikonfirmasi</a>
													    <? } ?>
													</td>
												</tr>
												<? } ?>
