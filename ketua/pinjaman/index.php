                                        ...
                                        <table class="table" id="tables">
											...
											<tbody>
												...
												<tr>
													...
													<a class="btn btn-primary" href="<? echo cfg(url); ?>ketua/pinjaman/rincian?1=<? echo $data_pinjaman['id']; ?>">ID<? echo $data_pinjaman['id']; ?></a>
													<? } else { ?>
                                                    ...
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>ketua/pinjaman/tolak?1=<? echo $data_pinjaman['id']; ?>">Tolak</a></li>
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>ketua/pinjaman/setujui?1=<? echo $data_pinjaman['id']; ?>">Setujui</a></li>
                                                    <li>
                                                    <? } ?>
                                                    </td>
													<td>
