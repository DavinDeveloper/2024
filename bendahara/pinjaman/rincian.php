                                        ...
                                        <table class="table" id="tables">
											...
											<tbody>
												...
												<tr>
													...
													<td>
													<? if ($data_angsuran['tipe'] != 'Belum Dibayar') { ?>
                                                    ...
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/pinjaman/bayar?1=<? echo $data_angsuran['id']; ?>&2=Cash">Cash</a></li>
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/pinjaman/bayar?1=<? echo $data_angsuran['id']; ?>&2=Transfer">Transfer</a></li>
                                                    <li>
                                                    <? } ?>
                                                    </td>
                                                    <td>
