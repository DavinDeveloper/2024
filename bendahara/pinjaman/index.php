					...
					<div class="card-body ">
						<div class="card">
								<div class="card-header">
									<div class="card-title">Daftar Pinjaman</div>
								</div>
									<div class="card-body">
                                        ...
                                        <table class="table" id="tables">
											...
											<tbody>
											    <?
											    $no = 1;
											    $check_pinjaman = mysqli_query($db, "SELECT * FROM pinjaman ORDER BY id ASC");
												...
												<tr>
													...
													<td>
													    ...
													    <a class="btn btn-primary" href="<? echo cfg(url); ?>bendahara/pinjaman/rincian?1=<? echo $data_pinjaman['id']; ?>">ID<? echo $data_pinjaman['id']; ?></a>
													    <? } else { ?>
													    <button class="btn btn-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false">ID<? echo $data_pinjaman['id']; ?></button>
													    <? } ?>
													</td>
													<td><? echo $data_pinjaman['username']; ?></td>
                                                    ...
                                                    <? echo $data_pinjaman['status']; ?>
                                                    </button>
                                                    <? } else if ($data_pinjaman['pengajuan'] == 'Menunggu') { ?>
													<button class="btn btn-outline-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <? echo $data_pinjaman['pengajuan']; ?>
                                                    </button>
                                                    <? } else if ($data_pinjaman['pengajuan'] == 'Ditolak') { ?>
                                                    ...
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/pinjaman/bayar?1=<? echo $data_pinjaman['id']; ?>&2=Cash&3=Yes">Cash</a></li>
                                                    <li><a class="dropdown-item" href="<? echo cfg(url); ?>bendahara/pinjaman/bayar?1=<? echo $data_pinjaman['id']; ?>&2=Transfer&3=Yes">Transfer</a></li>
                                                    <li>
                                                    <? } ?>
                                                    </td>
													<td>
