...
include '../session.php';
$check_angsuran = mysqli_query($db, "SELECT * FROM angsuran WHERE bulan = '".$_GET['1']."' ORDER BY id ASC");
if (mysqli_num_rows($check_angsuran) == 0) {
    header("Location: ".cfg(url)."anggota/pinjaman");
}
					...
					<div class="card-body ">
						<div class="card">
								<div class="card-header">
									<div class="card-title">Angsuran Bulan <? echo $_GET['1']; ?></div>
								</div>
									<div class="card-body">
